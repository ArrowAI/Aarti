...
import aarticlientLogo from '../img/aarticlient-no-background.png'
  ...
  return (
    <Stack component='header' paddingTop={defaultPadding} {...props}>
      <Stack direction='row' justifyContent='space-between'>
        <Box component='img' src={aarticlientLogo} width={100} sx={{padding: defaultPadding, paddingLeft: '0 !important'}}/>
        <ButtonGroup>
